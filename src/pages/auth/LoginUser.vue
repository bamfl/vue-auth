<template>
  <q-page class="flex flex-center">
    <q-card>
      <q-card-section>
        <div class="text-center q-mb-lg menu-icon">Вход</div>
          ...
          <q-form ref="loginForm" @submit="onSubmit" class="q-gutter-md">
            ...
            <div class="row justify-between">
              <q-btn
                ...
                color="primary"
                :disable="
                  !isValidRecaptcha || !(form.username && form.password)
                "
              />
              <q-btn
                label="Регистрация"
...
import { IRefForm, ILoginForm } from 'src/types/types';
